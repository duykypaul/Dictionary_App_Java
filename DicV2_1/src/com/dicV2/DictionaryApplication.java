...
public class DictionaryApplication extends javax.swing.JFrame {
    ...
    public DictionaryApplication() {
        initComponents();
        initDefault();
        for(Word ele : ListWordHistory.listWordHistory) {
            ele.printWord();
        }
        updateCntWord();
    }
    ...
    private void initComponents() {
        ...
        jHideWindow = new javax.swing.JLabel();
        ...
        jPaneDrag.add(jExit, new org.netbeans.lib.awtextra.AbsoluteConstraints(732, 0, 38, 40));
        ...
        jHideWindow.setBackground(new java.awt.Color(0, 0, 34));
        jHideWindow.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jHideWindow.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/icons8_Subtract_30px.png"))); // NOI18N
        jHideWindow.setOpaque(true);
        jPaneDrag.add(jHideWindow, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 0, 32, 40));
        ...
        jPanel1.add(jPaneDrag, new org.netbeans.lib.awtextra.AbsoluteConstraints(2, 2, 770, 38));
...
//    }
    ...
    private void initDefault() {
        ...
        System.out.println(ListWordHistory.listWordHistory.size());
        System.out.println(ListWordSaved.listWordSaved.size());
    }
    ...
    private void setCursor() {
        ...
        jHideWindow.setCursor(new Cursor(Cursor.HAND_CURSOR));
    ...
    private javax.swing.JLabel jHideWindow;
